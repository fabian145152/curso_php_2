...
<body class="aa">
    ...
    <h3>Esto es igual al anterior solo que en vehiculos.php</h3>
    <h3>en la clase camion agrego extend Coche y agrego las clases y las instancias del Objeto Coche a Camion</h3>
    ...
    /*
        La instancia frenar es de la clase auto pero esta heredada a la clase Camion
        y $pgaso es una clase de camion
    */
